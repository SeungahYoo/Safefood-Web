...
<body>
	...
	<div class="modal fade" id="modalRegisterForm3" tabindex="-1"
		...
		<div class="modal-dialog" role="document">
			<form action="/memberModify.mvc" method="post">
					...
					<div class="modal-body mx-3">
						<div class="md-form mb-5">
							<i class="fas fa-user prefix grey-text"></i> <input type="text"
								...
								value="${m.name}"> <label data-error="wrong"
						...
						<div class="md-form mb-5">
							<i class="fas fa-pen prefix grey-text"></i> <input type="text"
								...
								disabled="disabled" value="${m.id}"> <label
								data-error="wrong" data-success="right" for="orangeForm-email">${m.id }</label>
						</div>
						<div class="md-form mb-4">
							<i class="fas fa-lock prefix grey-text"></i> <input
								type="password" id="orangeForm-pass" name="password"
								value="${m.password}" class="form-control validate"> <label
								data-error="wrong" data-success="right" for="orangeForm-pass">${m.password }</label>
						</div>
						<div class="md-form mb-4">
						...
						<div class="md-form mb-4">
							<i class="fas fa-phone prefix grey-text"></i> <input type="text"
								...
								value="${m.tel}"> <label data-error="wrong"
								data-success="right" for="orangeForm-pass">${m.tel }</label>
						</div>
						<div>
							<div class="md-form mb-4">
							...
							<div>
								<input type="checkbox" id="dae" name="allergies" value="dae"
									<% 
